export async function onRequest(context) {
  ...
  const res = await fetch('https://api.mch.weixin.qq.com/pay/unifiedorder', { method: 'POST', body: xml });
  ...
  const payHash = await crypto.subtle.digest('MD5', new TextEncoder().encode(paySignStr));
