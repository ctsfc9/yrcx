...
onMounted(async () => {
  ...
  if (!GLOBAL_RIDE_ID) {
      ...
      // 直达链接：保持 URL，但压入一个状态供返回使用
      window.history.pushState({ page: 'detail' }, null, document.URL);
  }
