...
// ★★★ 弹窗状态管理 (修复变量名冲突) ★★★
// 使用独立的 ref，避免 reactive 对象深层监听失效
const showRolePopup = ref(false);
const showDatePicker = ref(false);
const showPaymentDialog = ref(false); // 核心修复：发布弹窗控制
...
.location-group { position: relative; } /* 修复：给互换按钮定位基准 */
