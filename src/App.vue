...
const onPreSubmit = () => {
  ...
  uiState.showPaymentDialog = true; 
};
...
const handlePopState = () => {
  if (uiState.showRole || uiState.showMap || uiState.showShare || uiState.selectedRide || uiState.showDate || uiState.showPaymentDialog) {
    uiState.showRole = false;
    uiState.showMap = false;
    uiState.showShare = false;
    uiState.selectedRide = null;
    uiState.showDate = false;
    uiState.showPaymentDialog = false;
